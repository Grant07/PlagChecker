# Generated by Django 5.0.3 on 2024-06-01 14:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('similarity_results', models.JSONField(encoder=json.encoder.JSONEncoder)),
                ('submission', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='plagiarism_reports', to='PlagiarismApp.submission')),
            ],
        ),
        migrations.CreateModel(
